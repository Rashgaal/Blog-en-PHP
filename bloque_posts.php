<div class="row masonry">
    ...
    <div class="bricks-wrapper">
        ...
        $total_entradas = $conexion->query($sql);

        $totalPaginas = ceil($total_entradas->num_rows / $post_por_pagina); // Calcula el número total de páginas
        
        
        $paginaActual = isset($_GET['pagina']) ? (int) $_GET['pagina'] : 1;
        $offset = ($paginaActual - 1) * $post_por_pagina;
        $sql = "SELECT * FROM entradas ORDER BY fecha_creacion_entrada DESC LIMIT $post_por_pagina OFFSET $offset";
